(ns foreclojure-solutions.p164
  (:use midje.sweet))

(defn __ []
  "Implement me!")

(future-fact "Language of a DFA"
  #{"a" "ab" "abc"} => (set (__ '{:states #{q0 q1 q2 q3}
                :alphabet #{a b c}
                :start q0
                :accepts #{q1 q2 q3}
                :transitions {q0 {a q1}
  ...
  (= #{"hi" "hey" "hello"}
     (set (__ '{:states #{q0 q1 q2 q3 q4 q5 q6 q7}
                ...
                :transitions {q0 {h q1}
                              ...
                              q5 {l q6}
                              q6 {o q7}}}))) => true
  (set (let [ss "vwxyz"] (for [i ss, j ss, k ss, l ss] (str i j k l)))) => (set (__ '{:states #{q0 q1 q2 q3 q4}
                :alphabet #{v w x y z}
                :start q0
                :accepts #{q4}
